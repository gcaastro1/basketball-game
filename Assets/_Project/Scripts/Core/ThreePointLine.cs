...
namespace Basket.Core
{
    ...
    // Shared by the scoring (Gameplay) and the AI's reads.
    public static class ThreePointLine
    {
        public static bool IsBeyond(Vector3 feet, Vector3 rimCenter, float radius, float cornerDistance = 0f)
        {
