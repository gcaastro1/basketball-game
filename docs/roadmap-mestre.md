...
| 6.6 Ginásio e bola | Ginásio (MarpaStudio) montado em volta da quadra, bola real (TierrasDeRol), quadra e linha de 3 NBA (cantos retos) | `ArenaVisualTests` (piso NBA alinhado à quadra, bola de 0,24 m, sem colisores novos), `CourtDataTests`, `ScoringMathTests` | 🔄 — plano: `docs/etapas/etapa-6.6-ginasio-e-bola.md`, decisão D-026 |
