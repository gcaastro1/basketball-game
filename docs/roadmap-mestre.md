...
| 6.5 Clipes reais + câmera | Clipes Mixamo/UAL (locomoção por velocidade, drible na parte de cima), procedural para o resto; câmera de transmissão virada para o ataque | `AnimationClipLogicTests`, `CameraRigMathTests`, `CharacterVisualTests`, `CameraControllerTests` | ⏳ — decisões D-022, D-023 |
