...
| 6 Animação | Rig Humanoid, Animator/blend trees, sockets/IK de mão e bola | Placeholders trocados sem mudar gameplay (`CharacterVisualTests`) | ✅ código / ⏳ CI — plano: `docs/etapas/etapa-6-animacao.md` |
